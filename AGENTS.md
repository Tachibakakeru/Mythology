...
- 日本神話原創節點插畫目前完成 63 個節點；第七批新增神議、太玉、天兒屋、天手力男、天忍穗耳、天菩比、饒速日、天火明、大年、鹿屋野比賣與水波能賣，希臘另新增不死鳥一張。完整名單以 `NODE_PORTRAITS` 為準；人物、神獸、故事與神器皆沿用 256×256 圓形透明 PNG 與相同圖說規格，加入前須檢查 alpha 外緣並同步更新本檔與 `PROGRESS.md`。原典沒有固定外貌的原初神應優先採抽象象徵，或在原創人物化提示與進度中明確註明非公認形象。
