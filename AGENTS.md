...
- 日本神話原創節點插畫目前完成 52 個節點；第五、六批新增迦具土、大山祇、豐受大神、磐長姬、海幸彥、鸕鶿草葺不合尊、玉依媛、須勢理媛、大物主、事代主、神功皇后、弟橘媛、天御中主、高皇產靈、神皇產靈、國常立、宗像三女神、味耜高彥根、天若日子、下照姬、天探女、高倉下。完整名單以 `NODE_PORTRAITS` 為準；人物、神獸、故事與神器皆沿用 256×256 圓形透明 PNG 與相同圖說規格，加入前須檢查 alpha 外緣並同步更新本檔與 `PROGRESS.md`。原典沒有固定外貌的原初神應優先採抽象象徵，或在原創人物化提示與進度中明確註明非公認形象。
